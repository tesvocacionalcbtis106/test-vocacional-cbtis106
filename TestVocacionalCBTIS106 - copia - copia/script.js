...
const keyToEspecialidad = {
  Dietetica: 'Dietética',
  Programacion: 'Programación',
  Ciberseguridad: 'Ciberseguridad',
  Electricidad: 'Electricidad',
  'Robótica_y_Automatización': 'Robótica y Automatización',
  Recursos_Humanos: 'Recursos Humanos',
  Comercio_Internacional_y_Aduanas: 'Comercio Internacional y Aduanas'
};
...
async function init() {
  try {
    ...
    questionsRoot.innerHTML = '<p style="color:#ef4444;font-weight:600;">Error al cargar preguntas.json. Verifica que el archivo exista en la raíz del proyecto.</p>';
  }
